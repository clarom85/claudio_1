...
async function run() {
  ...
  const baseSiteConfig = {
    ...
    tagline: NICHE_TAGLINES[site.niche_slug] || `${siteName}: expert guides and real data.`,
    homepageSubline: NICHE_HOMEPAGE_SUBLINE[site.niche_slug] || '',
    headerBadge: NICHE_HEADER_BADGE[site.niche_slug] || '',
    categories,
    toolSlug,
    toolLabel,
    hasCostTracker: true,
