...
export function renderArticlePage(article,site,relatedArticles=[]){
  ...
  const body=`${header(site)}<main class="site-main"><div class="wrap">
    <header class="art-hdr">
      <span class="art-kicker">${esc(article.category||'GUIDE')}</span>
    ...
    <div class="art-layout">
      ...
      <aside>
        ...
        <div class="nl-box"><h3>Stay Informed</h3><p>Expert guides delivered weekly</p><form onsubmit="return false"><input type="email" placeholder="your@email.com"/><button>Subscribe</button></form></div>
        <div class="ad ad-sidebar"><ins class="adsbygoogle" style="display:block" data-ad-format="rectangle"></ins></div>
      </aside>
    </div>
