...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      const profile = await api.get<{ data: { name: string } | null }>('/api/profiles/me')
      setAuth(
        { id: '', email, name: profile.data?.name },
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-aura-dark">
      ...
      >
        ...
        <div className="space-y-3">
          <button className="w-full glass py-3 rounded-xl flex items-center justify-center gap-3 hover:bg-white/10 transition-all font-medium">
